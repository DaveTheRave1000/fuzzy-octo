...
export class UI {
  ...
  update() {
    ...
    // Update global stats
    this.elements.money.textContent = `${gameState.btc.toFixed(8)} BTC`;
    this.elements.reputation.textContent = `Rep: ${gameState.reputation}`;
    this.elements.uptime.textContent = `Uptime: ${gameState.uptimeFormatted}`;
    this.elements.cpuUsage.textContent = `CPU: ${gameState.cpuUsage}%`;
